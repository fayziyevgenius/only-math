    ...
    try {
      ...
      */
      ...
      =====================================================
        ...
        Server 200 yoki 4xx qaytarsa ham
        resultni ishlatamiz.
      =====================================================
      */
      ...
      */
      ...
      const correctResult: GuessResult[] =
        Array(
          GUESS_LENGTH
        ).fill(
          "correct"
                              ...
                              (
                                ...
                                return (
                                  ...
                                  >
                                    ...
                                    <div className="text-[9px] uppercase tracking-wider font-bold mt-1 opacity-70">
        ...
        <section className="max-w-3xl mx-auto mt-10 grid grid-cols-1 md:grid-cols-3 gap-3">
          ...
          <div className="rounded-2xl border border-zinc-800 bg-zinc-900/40 p-5">
            ...
            <p className="text-xs text-zinc-600 leading-relaxed">
              Belgi passwordda bor va
              joylashuvi ham to'g'ri.
            </p>
